...
inline int calcPriorityScore(const string& u, int seed_list_dist, int domains_from_seed=0) {
...
inline size_t get_priority_bucket(const string& url, int seed_list_dist, int domains_from_seed = 0) {
